...
\section{Descrição do aplicativo}
  ...
  \section{Fluxos principais}
    ...
    Ao selecionar um marcador no mapa, o usuário acessa o perfil da quadra, onde encontra informações como endereço, características básicas, avaliação média, futs recentes e futs agendados. A tela apresenta também o botão "Como chegar", que abre o aplicativo de mapas do dispositivo com rota até o local. No perfil da quadra, o usuário pode consultar a agenda com futs agendados e eventos recorrentes para os próximos dias, o que auxilia na escolha de horários disponíveis e fornece uma noção da atividade da quadra ao longo da semana. Usuários autenticados podem favoritar a quadra para acessá-la rapidamente no futuro.
