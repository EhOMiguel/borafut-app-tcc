...
Desenvolver e avaliar uma solução multiplataforma para apoiar a organização do futebol amador em Brasília, conectando jogadores, quadras e grupos locais por meio de funcionalidades intuitivas e acessíveis, com vistas a ampliar a realização de partidas, fortalecer o engajamento comunitário e valorizar os espaços públicos esportivos.
...
\begin{enumerate}
    ...
    \item Disponibilizar o Produto Mínimo Viável (MVP) em ambiente piloto.
